<div>
 ...
 @section('content')
    <div class="container mx-auto px-4">
        ...
        <p class="text-lg mt-2 text-gray-600">My posts start from below.</p>
        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-green-700">
                                <p>The new post has been saved.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="sm:col-span-6 pt-5">
                ...
                <p class="mt-2 text-sm text-gray-500">Add the body for the post.</p>
            </div>
